...
#if defined(CONFIG_NETSHIELD_HOOK)
...
static inline void nf_nat_decode_session(struct sk_buff *skb, struct flowi *fl, int family) 
{
 ...
 static inline int nf_setsockopt(struct sock *sk, u_int8_t pf, int val, 
		 char __user *opt, unsigned int len) 
{ 
	return 0;     
}
 static inline int nf_getsockopt(struct sock *sk, u_int8_t pf, int val, 
